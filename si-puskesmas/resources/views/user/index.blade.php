<x-dashboard-layout>
    <section class="flex flex-col gap-4">
        ...
        <div class="justify-between flex mt-6">
            ...
            <x-bladewind::button href="{{route('user.create')}}" class="w-60 rounded-md text-center" size="small" tag="a">Tambah Pengguna</x-bladewind::button>
            ...
            <x-bladewind::table has_border="true" striped="true" celled="true">
                ...
                <tr>
                    ...
                    <td class="inline-flex items-center gap-2 w-full">
                        <x-bladewind::button tag="a" class="inline-flex items-center p-2 px-3 text-center rounded-md" href="{{ route('user.edit', $d->id) }}">
